...
?>
    ...
    ?>
            ...
            <form method="post" name="zipup" action="settings.php" />
...
<?php
            ...
            $zip = $_POST['zip'];
			$sql="UPDATE zipcode from c_cs147_misslynn.users SET zipcode=zip where userID = 1";
			...
			<br/><br/>
			<p><a href="#updateInfo" data-role="button" data-rel="dialog" data-transition="pop">Update Your Information</a></p>
    </div>
  </div><!-- /page settings -->
